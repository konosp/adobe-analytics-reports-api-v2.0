...
class aa_client:
    ...
    def __init__(self, adobe_org_id, subject_account, client_id, client_secret, account_id, private_key_location = '.ssh/private.key'):
        ...
        self.adobe_auth_url = os.path.join(self.adobe_auth_host, 'ims/exchange/jwt')
    ...
    def _get_jwtPayload(self, expiration = datetime.utcnow()):
        ...
        jwtPayloadJson['aud'] = os.path.join(self.adobe_auth_host,'c',self.client_id)
    ...
    def _renew_access_token(self):
        ...
        result = requests.post(self.adobe_auth_url, data = accessTokenRequestPayload)
    ...
    def _format_date_range(date_start, date_end):
        ...
        date_end = date_end + timedelta(hours=23,minutes=59,seconds=59, milliseconds=999)
    ...
    def _set_report_setting(self, setting_item, value):
        self.report_object = self._add_key_to_dict(self.report_object, 'settings')
        self.report_object['settings'] = self._add_key_to_dict(self.report_object['settings'] , setting_item) 
